    ...
    return [
        {
            ...
            description: 'Execute a raw GET request to any NSP REST or RESTCONF endpoint. Use this to explore unknown API paths, retrieve intent schemas, service layer data, or any endpoint not covered by other tools. The path should start with / and include the full API path after the server base URL.',
            inputSchema: {
                type: 'object',
                required: ['path'],
                properties: {
                    path: {
                        type: 'string',
                        description: 'Full API path starting with /. Examples:\n' +
        ...
        },
        {
            ...
            description: 'Execute a raw POST request to any NSP REST or RESTCONF endpoint. Use for operations like nsp-inventory:find with custom xpath, or any other POST-based query.',
            inputSchema: {
                type: 'object',
                required: ['path', 'body'],
                properties: {
...
export async function handleRestconfTool(name, args, client) {
    switch (name) {
...
//# sourceMappingURL=restconf.js.map